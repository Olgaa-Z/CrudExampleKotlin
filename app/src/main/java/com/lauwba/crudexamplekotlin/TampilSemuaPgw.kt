...
class TampilSemuaPgw : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    private fun showEmployee() {
        ...
        try {
            ...
            for (i in 0 until result.length()) {
                ...
                val name = jo.getString(Config.TAG_NAMA)

                val employees = HashMap<String, String>()
                employees[Config.TAG_ID] = id
                employees[Config.TAG_NAMA] = name
                list.add(employees)
            }
        ...
        val adapter = SimpleAdapter(
            this@TampilSemuaPgw, list, R.layout.list_item,
            arrayOf(Config.TAG_ID, Config.TAG_NAMA),
    ...
    override fun onItemClick(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
        val intent = Intent(this, TampilPegawai::class.java)
